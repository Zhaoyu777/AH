    ...
    public function getUploadFileAccept($targetType, $only = '')
    {
        ...
        $availableAccepts = array(
            'video' => array(
                ...
                'mimeTypes' => array('video/mp4', 'video/mpeg', 'video/x-la-asf', 'video/x-ms-asf', 'video/x-msvideo', 'video/x-sgi-movie', 'video/quicktime', 'video/3gpp', 'video/x-ms-wmv', 'video/x-flv'),
            ),
            'local_video' => array(
