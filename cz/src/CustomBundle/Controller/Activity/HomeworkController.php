...
class HomeworkController extends BaseController
{
    ...
    {
        if ($preview) {
            return $this->previewHomework($activity['id'], $activity['fromCourseId'], $task);
        }
        ...
        return $this->forward('CustomBundle:Homework:startDo', array(
    ...
    {
        return $this->previewHomework($task['activityId'], $task['courseId'], $task);
    }

    protected function previewHomework($id, $courseId, $task)
    {
