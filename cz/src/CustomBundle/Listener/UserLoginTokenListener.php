...
class UserLoginTokenListener
{
    ...
    public function onGetUserLoginListener(GetResponseEvent $event)
    {
        ...
        // if (empty($user['passwordChange'])
        //     && !in_array($route, $this->autoLoginRoutes)
        //     && strpos($path, '/weixin') !== 0
        //     ) {
        //     $response = new RedirectResponse('/settings/password', '302');
        //     $event->setResponse($response);
        // }
