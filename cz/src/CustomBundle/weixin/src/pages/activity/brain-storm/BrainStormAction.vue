  ...
  <div class="activity-action">
    ...
    <div v-else>
      <div v-if="role == 'teacher'">
        <button class="weui-btn weui-btn_primary" v-if="activityData.status !== 'created' && !brainStorm.status" @click="start">开始回答</button>
        <button class="weui-btn weui-btn_warning" v-else-if="brainStorm.status === 'start'" @click="end">停止回答</button>
        <button class="weui-btn weui-btn_default" v-else-if="brainStorm.status === 'end'">
          已停止回答
        </button>
      </div>
