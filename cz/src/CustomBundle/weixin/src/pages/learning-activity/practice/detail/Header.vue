<template>
  <div class="weui-flex wall-comment__header" v-if="contentData">
    <img :src="contentData.avatar ? host + contentData.avatar : host + avatarCover" class="code-avatar wall-comment__avatar">
    <div class="weui-flex__item">
      <div class="wall-comment__title">{{ contentData.name }}</div>
      <div class="wall-comment__thumb" :style="{backgroundImage: `url(${host}${contentData.thumb})` }"
           @click="previewPhoto(contentData.thumb)"></div>
    </div>
  </div>
</template>
